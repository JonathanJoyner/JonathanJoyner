...
##  InsightSoftware
{
    [Array]$UserData = Import-Csv "C:\Users\JonathanJ\OneDrive - insightsoftware\Documents\CSV\NamelyTestCSV.csv" | Select-object `
    ...
    @{n='Country';e={$_.'Office Address Country Name'}}, `
